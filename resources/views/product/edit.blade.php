    ...
    <div class="m-10">
        ...
        <form action="{{ route('product.update',$products->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{$products->name}}"  placeholder="Name Product"
            ...
            <div class="mb-4">
                ...
                <input type="number" name="price" value="{{$products->price}}" placeholder="Rp 0"
                    class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500"
                    autocomplete="off">
            </div>
            <div class="mb-4">
                <label class="block text-gray-600">Quantity</label>
                <input type="number" name="quantity" value="{{$products->quantity}}" placeholder="Rp 0"
                    class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500"
                    autocomplete="off">
            </div>
            ...
            <div class="mb-4">
                ...
                <select id="catagory" name="catagory_id"
                    class=" block   w-full text-sm text-gray-500  border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500 peer">
